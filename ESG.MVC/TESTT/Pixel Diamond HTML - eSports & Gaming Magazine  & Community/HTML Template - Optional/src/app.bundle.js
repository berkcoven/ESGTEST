...
--------------*/
// Make images liquid
require('./js/_global/global.liquid'); // Load Video Previews


require('./js/_global/global.videoPreview'); // Load SVGs


require('./js/_global/global.svgLoader'); // Load Counters


require('./js/_global/global.counter'); // Load ChartJS global config


require('./js/_global/global.chart'); // Load Accordion


require('./js/_global/global.accordion');
/*--------------
    HEADER
--------------*/
// Load header Dropdowns


require('./js/header/header.dropdown');
/*--------------
    MENU
--------------*/
// Load menu Arcs
...
require('./js/menu/menu.arc'); // Load menu Sliders


require('./js/menu/menu.slider'); // Load menu Progress Bars


require('./js/menu/menu.progressBar'); // Load menu Search


require('./js/menu/menu.search'); // Load menu Inventory Bag


require('./js/menu/menu.inventoryBag'); // Load menu Mobile Menu


require('./js/menu/menu.mobileMenu');
/*--------------
    BANNER
--------------*/
// Load banner Sliders
...
require('./js/banner/banner.slider'); // Load banner Lineslide


require('./js/banner/banner.lineslide');
/*--------------
    BODY
--------------*/
// Load body Sliders
...
require('./js/body/body.slider'); // Load body Dropdowns


require('./js/body/body.dropdown'); // Load body Progress Bars


require('./js/body/body.progressBar'); // Load body Tooltips


require('./js/body/body.tooltip'); // Load body Arcs


require('./js/body/body.arc'); // Load body Popups


require('./js/body/body.popup'); // Load body Tabs


require('./js/body/body.tab'); // Load body Countdowns


require('./js/body/body.countdown'); // Load body Calendar


require('./js/body/body.calendar'); // Load body Maps


require('./js/body/body.map'); // Load body Charts


require('./js/body/body.chart');
/*--------------
    SIDEBAR
--------------*/
// Load sidebar Arcs
...
require('./js/sidebar/sidebar.arc'); // Load sidebar Slider


require('./js/sidebar/sidebar.slider'); // Load sidebar Progress Bars


require('./js/sidebar/sidebar.progressBar'); // Load sidebar Countdown


require('./js/sidebar/sidebar.countdown'); // Load sidebar Tooltips


require('./js/sidebar/sidebar.tooltip'); // Load sidebar Calendar


require('./js/sidebar/sidebar.calendar'); // Load sidebar Maps


require('./js/sidebar/sidebar.map');
/*--------------
    POST
--------------*/
// Load post Sliders
...
require('./js/post/post.slider'); // Load post Arcs


require('./js/post/post.arc'); // Load post Progress Bars


require('./js/post/post.progressBar');
/*--------------
    FOOTER
--------------*/
// Load footer Slider
...
require('./js/footer/footer.slider'); // Load footer Arcs


require('./js/footer/footer.arc');
/*--------------
    WIDGETS
--------------*/
// Load Twitch Widget
...
require('./js/widget/widget.twitch'); // Load Twitter Widget


require('./js/widget/widget.twitter'); // Load Instagram Widget


require('./js/widget/widget.instagram');

},{"./js/_global/global.accordion":4,"./js/_global/global.chart":5,"./js/_global/global.counter":6,"./js/_global/global.liquid":7,"./js/_global/global.svgLoader":8,"./js/_global/global.videoPreview":9,"./js/banner/banner.lineslide":10,"./js/banner/banner.slider":11,"./js/body/body.arc":12,"./js/body/body.calendar":13,"./js/body/body.chart":14,"./js/body/body.countdown":15,"./js/body/body.dropdown":16,"./js/body/body.map":17,"./js/body/body.popup":18,"./js/body/body.progressBar":19,"./js/body/body.slider":20,"./js/body/body.tab":21,"./js/body/body.tooltip":22,"./js/footer/footer.arc":23,"./js/footer/footer.slider":24,"./js/header/header.dropdown":25,"./js/menu/menu.arc":26,"./js/menu/menu.inventoryBag":27,"./js/menu/menu.mobileMenu":28,"./js/menu/menu.progressBar":29,"./js/menu/menu.search":30,"./js/menu/menu.slider":31,"./js/post/post.arc":32,"./js/post/post.progressBar":33,"./js/post/post.slider":34,"./js/sidebar/sidebar.arc":35,"./js/sidebar/sidebar.calendar":36,"./js/sidebar/sidebar.countdown":37,"./js/sidebar/sidebar.map":38,"./js/sidebar/sidebar.progressBar":39,"./js/sidebar/sidebar.slider":40,"./js/sidebar/sidebar.tooltip":41,"./js/widget/widget.instagram":45,"./js/widget/widget.twitch":46,"./js/widget/widget.twitter":47}],4:[function(require,module,exports){
"use strict";

var app = require('../utils/app.core');
...
},{"../utils/app.core":43}],5:[function(require,module,exports){
"use strict";
...
},{"../utils/app.core":43}],6:[function(require,module,exports){
"use strict";

/**
 * COUNTERS
 */
var setupCounters = function setupCounters(selector) {
...
var attachCounterEvents = function attachCounterEvents(el) {
  var substractControl = el.querySelector('.counter-control.substract'),
...
(function () {
  var videoPreviews = document.querySelectorAll('.post-preview-video-wrap');
  if (!videoPreviews.length) return;

  var showVid = function showVid() {
    // hide overlay
    this.querySelector('.post-preview-overlay').style.visibility = 'hidden'; // hide img

    this.querySelector('.post-preview-img').style.visibility = 'hidden'; // show video

    this.querySelector('.post-preview-video-wrap').style.visibility = 'visible';
    this.removeEventListener('click', showVid);
  };

  videoPreviews.forEach(function (el) {
...
},{"../utils/app.core":43}],11:[function(require,module,exports){
"use strict";
...
},{"../utils/app.core":43}],12:[function(require,module,exports){
"use strict";
...
},{"../utils/app.core":43}],13:[function(require,module,exports){
"use strict";
...
app.createCalendar({
  ...
  events: (_events = {}, _defineProperty(_events, new Date(currentYear, currentMonth, 14), [{
    ...
    type: 'green'
  }]), _defineProperty(_events, new Date(currentYear, currentMonth, 26), [{
    name: 'League of Heroes Semifinals',
    info: 'some event info',
    type: 'violet'
  }]), _defineProperty(_events, new Date(currentYear, currentMonth - 1, 30), [{
    name: 'League of Heroes Semifinals',
    info: 'some event info',
    type: 'violet'
  }]), _events),
...
},{"../utils/app.core":43}],14:[function(require,module,exports){
"use strict";

var app = require('../../js/utils/app.core');

var ctx = document.querySelector('.chart-bars');
var chartBarsData = {
  type: 'bar',
  data: {
...
var ctx1 = document.querySelector('.chart-bars-single');
var chartBarsSingleData = {
  type: 'bar',
  data: {
...
var ctx2 = document.querySelector('.chart-lines');
var chartLinesData = {
  type: 'line',
  data: {
...
},{"../../js/utils/app.core":43}],15:[function(require,module,exports){
"use strict";
...
var ew1_match_pgb = app.createProgressBar({
  width: 140,
  container: '#ew1-match-cd-pgb',
  gradient: {
    colors: ['#713fcb', '#00e3d0']
...
},{"../utils/app.core":43}],16:[function(require,module,exports){
"use strict";
...
},{"../utils/app.core":43}],17:[function(require,module,exports){
"use strict";
...
},{"../utils/app.core":43}],19:[function(require,module,exports){
"use strict";
...
},{"../utils/app.core":43}],20:[function(require,module,exports){
"use strict";
...
},{"../utils/app.core":43}],21:[function(require,module,exports){
"use strict";
...
},{"../utils/app.core":43}],22:[function(require,module,exports){
"use strict";
...
},{"../utils/app.core":43}],23:[function(require,module,exports){
"use strict";
...
},{"../utils/app.core":43}],24:[function(require,module,exports){
"use strict";
...
},{"../utils/app.core":43}],25:[function(require,module,exports){
"use strict";
...
},{"../utils/app.core":43}],26:[function(require,module,exports){
"use strict";
...
},{"../utils/app.core":43}],27:[function(require,module,exports){
"use strict";
...
var inventoryBagTrigger = document.querySelector('.inventory-button'),
...
if (inventoryBagPreview && inventoryBagTrigger && inventoryBagClose) {
  ...
  var openInventory = function openInventory() {
  ...
  var closeInventory = function closeInventory() {
    if (!inventoryOpen) return;
...
},{"../utils/app.core":43}],28:[function(require,module,exports){
"use strict";
...
},{"../utils/app.core":43}],29:[function(require,module,exports){
"use strict";
...
},{"../utils/app.core":43}],30:[function(require,module,exports){
"use strict";
...
var searchPopupOpen = document.querySelectorAll('.search-popup-open'),
...
if (searchPopupOpen && searchPopupClose && searchPopup && searchPopupInput && searchPopupText) {
  searchPopup.style.height = "".concat(document.body.offsetHeight, "px");
  ...
  var closeSearchPopupOnKeyPress = function closeSearchPopupOnKeyPress(e) {
    if (e.keyCode === 27) {
      closeSearchPopup();
    }
  };

  var openSearchPopup = function openSearchPopup() {
    disableScroll();
  ...
  var closeSearchPopup = function closeSearchPopup() {
    enableScroll();
...
},{"../utils/app.core":43}],31:[function(require,module,exports){
"use strict";
...
},{"../utils/app.core":43}],32:[function(require,module,exports){
"use strict";
...
},{"../utils/app.core":43}],33:[function(require,module,exports){
"use strict";
...
},{"../utils/app.core":43}],34:[function(require,module,exports){
"use strict";
...
},{"../utils/app.core":43}],35:[function(require,module,exports){
"use strict";
...
},{"../utils/app.core":43}],36:[function(require,module,exports){
"use strict";
...
},{"../utils/app.core":43}],37:[function(require,module,exports){
"use strict";
...
var ew1_sd_pgb = app.createProgressBar({
  container: '#ew1-pgb-cd',
  gradient: {
    colors: ['#713fcb', '#00e3d0']
  },
...
},{"../utils/app.core":43}],38:[function(require,module,exports){
"use strict";
...
var app = require('../utils/app.core'); // POLL RESULTS
...
},{"../utils/app.core":43}],40:[function(require,module,exports){
"use strict";
...
},{"../utils/app.core":43}],41:[function(require,module,exports){
"use strict";
...
},{"../utils/app.core":43}],42:[function(require,module,exports){
"use strict";
...
function Overlay() {
  ...
  if (typeof Overlay.instance === 'undefined') {
    ...
    this.addTrigger = function (config) {
      var callback = function callback() {
        config.callback();

        _this.hide();

        _this.element.removeEventListener(config.event, callback);
      };

      _this.element.addEventListener(config.event, function (e) {
        if (e.target === this) {
          callback();
        }
      });
...
},{"./Overlay":42,"chart.js":1}],44:[function(require,module,exports){
"use strict";

module.exports.loadContent = function (config) {
  var me = {};

  var queryItems = function queryItems() {
    $.ajax({
      url: config.url,
...
(function () {
  var instaWidgetWrap = document.querySelector('.photo-list');
  ...
  var createInstagramItem = function createInstagramItem(data) {
    var item = " <!-- PHOTO ITEM WRAP -->\n      <a target=\"_blank\" href=\"".concat(data.link, "\" class=\"photo-item-wrap\">\n        <!-- PHOTO ITEM -->\n        <figure class=\"photo-item liquid\">\n          <img src=\"").concat(data.images.thumbnail.url, "\" alt=\"").concat(data.id, "\">\n        </figure>\n        <!-- /PHOTO ITEM -->\n\n        <!-- PHOTO ITEM OVERLAY -->\n        <div class=\"photo-item-overlay\">\n          <!-- PLUS CC ICON -->\n          <svg class=\"plus-cc-icon\">\n            <use xlink:href=\"#svg-plus-cc\"></use>\n          </svg>\n          <!-- /PLUS CC ICON -->\n        </div>\n        <!-- /PHOTO ITEM OVERLAY -->\n      </a>\n      <!-- /PHOTO ITEM WRAP -->");
    return item;
  };

  var createInstagramItems = function createInstagramItems(response) {
    var count = 12;
  ...
  var contentLoader = require('../utils/content-loader');
  /**
   *  INSTAGRAM FEED
   */
  ...
  var insta_access_token = 'YOUR_ACCESS_TOKEN',
      instaLoader = contentLoader.loadContent({
    url: "https://api.instagram.com/v1/users/self/media/recent/?access_token=".concat(insta_access_token),
...
},{"../utils/content-loader":44}],46:[function(require,module,exports){
"use strict";

var twitchPlayerContainer = document.querySelector('#streamer-twitch-channel-01');
...
var parseDate = function parseDate(dateText) {
  ...
  return "".concat(time, " ").concat(measure, " ago");
};
...
var tweetsContainer = document.querySelectorAll('.tweets-preview-widget');

var showLoading = function showLoading() {
  tweetsContainer.forEach(function (e) {
    var loader = document.createElement('div');
...
var createTweetItem = function createTweetItem(container, data) {
  ...
  if (container.classList.contains('v2')) {
    tweetItem.innerHTML += "<p class=\"tweets-prevew-widget-item-user\">@".concat(data.user.screen_name, "</p>\n    <img class=\"tweets-preview-widget-item-profile-img\" src=\"").concat(data.user.profile_image_url, "\" alt=\"profile-img\">");
  } else {
    tweetItem.innerHTML += "<!-- BUBBLE ORNAMENT -->\n    <a href=\"#\" class=\"bubble-ornament twt\">\n      <!-- TWITTER ICON -->\n      <svg class=\"twitter-icon\">\n        <use xlink:href=\"#svg-twitter\"></use>\n      </svg>\n      <!-- /TWITTER ICON -->\n    </a>\n    <!-- /BUBBLE ORNAMENT -->";
  }

  tweetItem.innerHTML += "<p class=\"tweets-preview-widget-item-text\">".concat(parseText(data.text), "</p>\n  <p class=\"tweets-preview-widget-item-timestamp\">").concat(parseDate(data.created_at), "</p>");
  return tweetItem;
};

var createTweetItems = function createTweetItems(response) {
  tweetsContainer.forEach(function (e) {
    e.innerHTML = '';
  });
  response.forEach(function (el) {
    tweetsContainer.forEach(function (e) {
      e.append(createTweetItem(e, el));
    });
  });
};
...
var tweetsLoader = contentLoader.loadContent({
  url: "http://localhost:3003/tweets_last/".concat(count),
  onLoading: showLoading,
  loadingDelay: 1000,

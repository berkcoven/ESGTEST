...
const lineSlideContent = [
  {
    title: 'Some text to slide',
    content: '. Some other text to slide on the same block',
    separator: ' -------- '
  },
  {
    title: 'Another block of text to slide',
    content: ', more text',
    separator: ' ******** '
  },
  {
    title: 'Content should be long enough in order for the lineslide to work properly',
    content: '. Lorem ipsum dolor et asum',
    separator: ' ******** '
  }
];

app.createLineslide({
  container: '#lineslide-d1',
  lineslide: '.lineslide-text', 
  speed: 1,
  lineslideItems: lineSlideContent
});

app.createLineslide({
  container: '#lineslide-d2',
  lineslide: '.lineslide-text', 
  speed: 2,
  lineslideItems: lineSlideContent
});
